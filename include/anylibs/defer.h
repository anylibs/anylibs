...
#define c_defer_init(defer_stack_capacity) \
  CDefer c_defer_var__ = {.nodes = (CDeferNode[defer_stack_capacity]){{0}}, .capacity = defer_stack_capacity}
...
#define c_defer(destructor, destructor_param)                                                               \
  if (c_defer_var__.len < c_defer_var__.capacity) {                                                         \
    c_defer_var__.nodes[c_defer_var__.len++] = (CDeferNode){(void (*)(void*))destructor, destructor_param}; \
  }
